...
$jscomp.polyfill("Array.from", function (a) {
    return a ? a : function (a, b, e) {
        ...
        if ("function" == typeof l) {
            a = l.call(a);
            for (var q = 0; !(l = a.next()).done;) d.push(b.call(e, l.value, q++))
        } else
...
(function (a) {
    ...
    d.t = function (a, b) {
        ...
        if (b & 2 && "string" != typeof a)
            for (var e in a) d.d(g, e, function (b) {
                return a[b]
            }.bind(null, e));
        return g
    };
    ...
    function e(a, f) {
        ...
        if (!h)
            if (h = a && ("undefined" !== typeof Symbol && a[Symbol.iterator] || a["@@iterator"]), null == h) h = void 0;
            else {
                var c = [],
                    b = !0,
                    d = !1,
                    m;
                try {
                    for (h = h.call(a); !(b = (m = h.next()).done) && (c.push(m.value), !f || c.length !== f); b = !0);
                } catch (B) {
                    d = !0;
                    var e = B
                } finally {
        ...
        if (!(a = m)) throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
        return a
    }
    ...
    function u() {
        C ? (!t && document.body && (t = document.createElement("div"), t.style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;", document.body.appendChild(t)), k = (t ? t.clientHeight : 0) || p.window.innerHeight || document.documentElement.clientHeight) : k = p.window.innerHeight || document.documentElement.clientHeight
    }

    function A(a) {
        for (var f = []; null !== a.parentElement;) a = a.parentElement, 1 === a.nodeType && f.push(a);
        return f
    }
    ...
    var n = p.window.navigator,
        ...
        n.userAgent.indexOf("Trident/") || -1 < n.userAgent.indexOf("Edge/"),
    ...
    var r = [],
        ...
        z = function () {
            ...
            v(a, [{
                    ...
                    value: function (a, b) {
                        if ("string" ===
                            typeof b) return p.window.getComputedStyle(a).getPropertyValue(b);
                    ...
                    key: "extend",
                    value: function (a) {
                        for (var b = arguments.length, c = Array(1 < b ? b - 1 : 0), f = 1; f < b; f++) c[f - 1] = arguments[f];
                        a = a || {};
                    ...
                    value: function () {
                        ...
                        if (!this.options.keepImg) {
                            ...
                            c && this.$item.setAttribute("data-jarallax-original-styles",
                                c);
                        ...
                        this.image.useImgTag ? b = this.extend({
                            ...
                            "max-width": "none"
                        }, a, b) : (this.image.$item = document.createElement("div"), this.image.src && (b = this.extend({
                        ...
                        "fixed" === this.image.position && (a = A(this.$item).filter(function (a) {
                            ...
                            var c = a["-webkit-transform"] || a["-moz-transform"] || a.transform,
                                b = /(auto|scroll)/;
                            return c && "none" !== c || b.test(a.overflow + a["overflow-y"] +
                                a["overflow-x"])
                ...
                },
                {
                    ...
                    value: function () {
                        var a = this.image.$container.getBoundingClientRect(),
                            ...
                            e = 0,
                            g = b;
                        d && (0 > c ? (e = c * Math.max(b, k), k < b && (e -= c * (b - k))) : e = c * (b + k), g = 1 < c ? Math.abs(e - k) : 0 > c ? e / c + Math.abs(e) : g + (k - b) * (1 - c), e /= 2);
                    ...
                    value: function (a) {
                        ...
                        if (a || this.isElementInViewport) {
                            ...
                            if ("scroll" === this.options.type || "scroll-opacity" === this.options.type) d = this.parallaxScrollDistance * r, "absolute" === this.image.position && (d -= c), f.transform = "translate3d(0,".concat(d, "px,0)");
    ...
    b = function (a, b) {
        if ("object" === ("undefined" === typeof HTMLElement ? "undefined" : l(HTMLElement)) ? a instanceof HTMLElement : a && "object" === l(a) && null !== a && 1 === a.nodeType && "string" === typeof a.nodeName) a = [a];
        for (var d = a.length, c = 0, e, f = arguments.length, g = Array(2 < f ? f - 2 : 0), k = 2; k < f; k++) g[k - 2] = arguments[k];
        for (c; c < d; c += 1)
            if ("object" === l(b) || "undefined" === typeof b ? a[c].jarallax ||
                (a[c].jarallax = new z(a[c], b)) : a[c].jarallax && (e = a[c].jarallax[b].apply(a[c].jarallax, g)), "undefined" !== typeof e) return e;
        return a
    };
    b.constructor = z;
    d["default"] = b
